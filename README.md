...
* Came across one errata so far, there's no `Math.ceiling` function, rather it's `Math.ceil` (page 33). Is also [reported, and other erata](http://www.oreilly.com/catalog/errata.csp?isbn=9780596517748)
